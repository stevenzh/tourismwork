...
public class TourCost implements java.io.Serializable {
  ...
  public TourCost(String planNo, int customerId, String costType,
      String description, BigDecimal unitPrice, Integer count, String unit,
      String currency, BigDecimal roe, BigDecimal fcAmount, BigDecimal amount,
      BigDecimal payAmount, char isMakePaper, String frChecked, Date created,
      Integer createdby) {
    this.planNo = planNo;
    this.customerId = customerId;
