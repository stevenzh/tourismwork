...
public class Invoice implements java.io.Serializable {
	...
	public Invoice(String recNo, String invNo, Integer incomeId, Date prtDate,
			String customs, String exp1, BigDecimal amount1, String exp2,
			BigDecimal amount2, String exp3, BigDecimal amount3, String exp4,
			BigDecimal amount4, Character type1, BigDecimal pamount1,
			Character type2, BigDecimal pamount2, Character type3,
			BigDecimal pamount3, Character type4, BigDecimal pamount4,
			String type5, BigDecimal pamount5, String remarks, Byte del,
			String signature, String casher, Integer opUser) {
		this.recNo = recNo;
		this.invNo = invNo;
