 ...
 */
@Entity
@Table(name = "tbl_crm_express", catalog = "tourismwork_db")
public class Express implements java.io.Serializable {
	...
	public Express(String expressId, String customer, String address,
			String tel, String orderId, Date expressDate, Date expressLastdate,
			String expressState, Date updated) {
	...
	public Express(String expressId, String caseId, String customer,
			String address, String tel, String orderId, String contactor,
			String zip, String expressType, String expressModlue,
			String payType, String payModlue, String line, Byte money,
			Date expressDate, Date expressLastdate, String teamNo,
			BigDecimal pay, String expressState, String memo, Long workflowId,
