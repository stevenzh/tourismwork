...
public class ShareFlight implements java.io.Serializable {
	...
	public ShareFlight(String flightNo, Date departureDate) {
		this.flightNo = flightNo;
		this.departureDate = departureDate;
	}

	public ShareFlight(String flightNo, String airwaysCode, Date departureDate,
			Integer seating, Integer handle, String note) {
		this.flightNo = flightNo;
