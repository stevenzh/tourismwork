 ...
 */
@Entity
@Table(name = "tbl_cpic_prem", catalog = "tourismwork_db")
public class Premium implements java.io.Serializable {
	...
	public Premium(String precode, BigDecimal prem, Integer preday,
			BigDecimal ywpre, BigDecimal ylpre, BigDecimal bcpre,
			BigDecimal clpre, BigDecimal hkpre, Date dodate, String note,
			Character del, Date created, Integer createdby, Date updated,
			Integer updatedby) {
		this.precode = precode;
		this.prem = prem;
		this.preday = preday;
