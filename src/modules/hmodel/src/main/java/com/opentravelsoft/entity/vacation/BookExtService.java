...
/**
 * BookExtService generated by hbm2java
 */
@Entity
@Table(name = "tbl_booking_ext", catalog = "tourismwork_db")
public class BookExtService implements java.io.Serializable {
	...
	public BookExtService(String bookingNo, Byte type, String productNo,
			Integer num, BigDecimal price, BigDecimal totalPrice, Date useDate,
			Integer state, String remark, Byte isDelete, String createdBy,
