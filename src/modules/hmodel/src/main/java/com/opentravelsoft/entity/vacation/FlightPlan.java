...
/**
 * FlightPlan generated by hbm2java
 */
@Entity
@Table(name = "tbl_flightplan", catalog = "tourismwork_db")
public class FlightPlan implements java.io.Serializable {
	...
	public FlightPlan(String flightPlanId, int mode, int flightAmount,
			BigDecimal adultExtendPrice, BigDecimal childExtendPrice,
	...
	public FlightPlan(String flightPlanId, int mode, Integer ticketType,
			...
			BigDecimal adultExtendPrice, BigDecimal childExtendPrice,
			Date startDate, Date endDate, boolean isDeleted, String createdBy,
			Date createdDate, String createdByIp, String modifiedBy,
			Date modifiedDate, String modifiedByIp) {
		this.flightPlanId = flightPlanId;
		this.mode = mode;
