...
/**
 * FitPlan generated by hbm2java
 */
@Entity
@Table(name = "tbl_planfit", catalog = "tourismwork_db")
public class FitPlan implements java.io.Serializable {
	...
	public FitPlan(String recNo, String lineNo, Character planType,
			String weekbit, Integer checkDays, Integer leastMan,
			BigDecimal price, Date SDate, Date EDate, Byte isDelete,
			Integer pax, Integer surpluspax, Integer confirmPax, Byte isShare,
			Integer shareFlightId, String createdBy, Date createdDate,
			String modifiedBy, Date modifiedDate, Character isLastMinute,
			BigDecimal discountRate, String createdByIp, String modifiedByIp) {
		this.recNo = recNo;
		this.lineNo = lineNo;
