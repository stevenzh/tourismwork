...
public class Guide implements java.io.Serializable {
	...
	public Guide(String accCd, String accNm, String accSex, String pinyin,
			...
			String bp, String mobile, String EMail, String address,
			String character, String taste, String speciality,
			String workRemark, String finishSchool, Date finishDate,
			Date birthday, String bthplc, String hzzl, String hzno,
			String hzadd, Date hzdate1, Date hzrang, String photoFile,
			String hkPass) {
		this.accCd = accCd;
		this.accNm = accNm;
		this.accSex = accSex;
