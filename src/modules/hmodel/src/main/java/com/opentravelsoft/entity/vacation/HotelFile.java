...
/**
 * HotelFile generated by hbm2java
 */
@Entity
@Table(name = "tbl_hotel_file", catalog = "tourismwork_db")
public class HotelFile implements java.io.Serializable {
	...
	public HotelFile(String recNo, String hotCd, String mapAddress,
			String note, Byte isDelete, String crUser, Date crDate,
			String opUser, Date opDate) {
		this.recNo = recNo;
		this.hotCd = hotCd;
