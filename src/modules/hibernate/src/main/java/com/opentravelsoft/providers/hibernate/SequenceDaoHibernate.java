...
public class SequenceDaoHibernate extends GenericDaoHibernate<Sequence, Long>
	 ...
	 * </ul>
	 */
	public String getComputerNo(String type, long groupId) {
		return getComputerNo(type, 1, groupId)[0];
	}

	public String[] getComputerNo(String type, int count, long groupId) {
		...
		if (type.equals("E") || type.equals("X")) {
			...
			tfj107Id.setRectype(type.charAt(0));
			tfj107Id.setYear(sYear);
			tfj107Id.setMonth(sMonth);

			HibernateTemplate template = getHibernateTemplate();

			Sequence seqList = (Sequence) template.get(Sequence.class,
					tfj107Id, LockMode.UPGRADE);
			...
			for (int i = 0; i < count; i++) {
				...
				} else if (type.equals("A") || type.equals("H")
						|| type.equals("J") || type.equals("K")
						|| type.equals("L") || type.equals("M")
						|| type.equals("N") || type.equals("O")
						|| type.equals("Q") || type.equals("R")
						|| type.equals("V") || type.equals("W")
						|| type.equals("Y") || type.equals("Z")
						|| type.equals("D")) {
					ComputerNo = sYear + sMonth
