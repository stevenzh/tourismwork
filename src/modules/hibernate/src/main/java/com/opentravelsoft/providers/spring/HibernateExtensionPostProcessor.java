package com.opentravelsoft.providers.spring;
 ...
 * add persistent classes to an Opentravelsoft application without modifying any of the existing Opentravelsoft Spring configuration
 * or jar distribution files.
 * 
 * <p>As an example consider the following Spring bean configuration:
 * 
 * <pre>
 * &lt;bean class=&quot;com.opentravelsoft.dao.spring.HibernateExtensionPostProcessor&quot;&gt;
 *     &lt;property name=&quot;mappingResources&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;com/opentravelsoft/model/Foo.hbm.xml&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 ...
 * applicationContext-dao.xml at the root level, then the standard Opentravelsoft configuration will automatically pick up the
 * new Spring configuration file and the new persistent classes will be added to the list already defined for the
 * session factory bean configured within the standard opentravelsoft-hibernate.jar file. And all this without needing to
 * touch the original Opentravelsoft configuration files!
 *
