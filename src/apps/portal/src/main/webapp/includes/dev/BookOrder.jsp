...
<s:form action="submitOrder" namespace="/distribution" method="post">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1">
    <tr>
      ...
      <td class="lstidx">报价<span class="required">*</span></td>
      <td class="lstidx">应收团款<span class="required">*</span></td>
