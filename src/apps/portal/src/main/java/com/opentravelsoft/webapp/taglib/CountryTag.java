package com.opentravelsoft.webapp.taglib;
...
//                sb.append(eval.evalString("prompt", prompt)).append("</option>\n");
            ...
            for (Object country1 : countries) {
              LabelValueBean country = (LabelValueBean) country1;
    ...
    protected List<LabelValueBean> buildCountryList(Locale locale) {
        final Locale[] available = Locale.getAvailableLocales();

        List<LabelValueBean> countries = new ArrayList<LabelValueBean>();
            ...
            if (!"".equals(iso) && !"".equals(name)) {
              LabelValueBean country = new LabelValueBean(name, iso);
                ...
                if (!countries.contains(country)) {
                    countries.add(new LabelValueBean(name, iso));
                }
            }
        }
    ...
    public class LabelValueComparator implements Comparator {
        ...
        public final int compare(Object o1, Object o2) {
          LabelValueBean lhs = (LabelValueBean) o1;
          LabelValueBean rhs = (LabelValueBean) o2;
