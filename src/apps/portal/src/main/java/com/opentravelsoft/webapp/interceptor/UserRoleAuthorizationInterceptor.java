...
public class UserRoleAuthorizationInterceptor implements Interceptor {
  ...
  protected static final Log logger = LogFactory
      .getLog(UserRoleAuthorizationInterceptor.class);
  private String[] authorizedRoles;

  /**
   * Intercept the action invocation and check to see if the user has the proper
   * role.
   * 
  ...
  public String intercept(ActionInvocation invocation) throws Exception {
    logger.debug("intercepter user role.");
