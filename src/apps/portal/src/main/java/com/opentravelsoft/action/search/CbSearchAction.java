...
public class CbSearchAction extends PortalAction {
   ...
   * 高亮显示
   */
  public String highLighter(String str1, String filedName, String queryString,
      String cssClassName) {
    ...
    SimpleHTMLFormatter formatter = new SimpleHTMLFormatter("<span class=\""
        + cssClassName + "\">", "</span>");
  ...
  private Line covert(Document doc) {
    ...
    fragment = highLighter(doc.get("routeTrait"), "routeTrait", queryString,
        "highlight1");
    if (null != fragment)
