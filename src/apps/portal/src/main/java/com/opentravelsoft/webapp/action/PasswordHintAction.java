 ...
 *
 */
public class PasswordHintAction extends PortalAction {
    ...
    public String execute() {
        ...
        if (username == null) {
            ...
            args.add(getText("member.username"));
        ...
        try {
            Member user = userManager.getUserByUsername(username);
            ...
            String subject = '[' + getText("webapp.name") + "] " + getText("member.passwordHint");
