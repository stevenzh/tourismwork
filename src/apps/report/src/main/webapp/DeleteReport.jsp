...
<div align="center">
	...
	<div class="warning" id="important" >
		<s:text name="deleteReport.warning"/>
    </div>  	

  <br>
  
  <div class="important img-delete" id="instructions" style="width: 70%;"><s:text name="deleteReport.title"/></div>
      
  <form action="deleteReport.action"  class="dialog-form" style="width: 75%;" >
