    ...
    <div class="error" id="errorMessages">    
      <s:iterator value="actionErrors">
        <img src="<s:url value="/images/iconWarning.gif"/>"
            alt="<s:i18n name='icon.warning'/>" class="icon" />
        <s:property/><br />
      </s:iterator>
   </div>
</s:if>
...
<s:if test="hasActionMessages()">
    <div class="error" id="actionMessages">    
...
<c:if test="${not empty messages}">
    <div class="message" id="successMessages">    
        <c:forEach var="msg" items="${messages}">
            <img src="<s:url value="/images/iconInformation.gif"/>"
                alt="<s:i18n name="icon.information"/>" class="icon" />
            <c:out value="${msg}"/><br />
        </c:forEach>
    </div>
