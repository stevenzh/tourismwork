...
function SubmitForm(param,target)
{
  ...
  fm.action = "<s:url action='deletePremium' namespace='/resource'/>"
  } 
  else if (param == 'modify') 
  {
  fm.action = "<s:url action='editPremium' namespace='/resource' />"
  }
  fm.submit();
}
...
<table align="left" border="0" style="width: 100%">
  <s:form method="post" action="listPremium" namespace="/resource" theme="simple">
