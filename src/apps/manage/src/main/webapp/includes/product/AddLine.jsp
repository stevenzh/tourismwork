...
<title>添加线路基本信息</title>
<meta name="menu" content="ProductMenu"/>
<meta name="heading" content="添加线路基本信息">
</head>
<body>
...
<s:form action="RouteAddSubmit" namespace="/product" method="post">
  ...
  <tr>
    <td colspan="4">
      <s:submit action="RouteAddSubmit" value="%{getText('common.forms.add')}"></s:submit>
      <s:submit action="showRouteSearch" value="%{getText('common.words.cancel')}"></s:submit>
    </td>
  </tr>
