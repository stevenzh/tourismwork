...
function SubmitForm(param, target)
{
  ...
  if (param =='delete')
  {
    ...
    fm.action = "<s:url action='deleteSight' namespace='/setting'/>"
  }
  if (param == 'modify') {
    fm.action = "<s:url action='editSight' namespace='/setting'/>"
  } else if (param == 'add') {
    fm.action = "<s:url action='editSight' namespace='/setting'/>"
  } 
...
<s:form action="listSights" namespace="/setting" method="POST" theme="simple">
