...
<title>查询内容</title>
<meta name="heading" content="[出境游名单打印] 第一步：查找团">
</head>
...
<table border="0" cellpadding="2" cellspacing="2" width="100%">
  ...
  <td colspan="14" ><a href="<s:url action='ToursSearchOutBandPrint' namespace='/operator' includeParams='none' />">更多</a></td>
</table>



<s:submit action="ToursSearchOutBandNext" value="下一步"></s:submit>
