 ...
 */
public class TSearchPrintAction extends ManageAction {
  private static final long serialVersionUID = -4562101264530149531L;

  protected static final Log logger = LogFactory
      .getLog(TSearchPrintAction.class);
  ...
  /** 出团日期 -开始 */
  private Date kenStartDate = new Date();
  ...
  public String print() {
    ...
    tour.setLocalEcontact(user.getUserName() + " " + user.getPhone());
